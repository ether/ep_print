...
`ep_print` runs inside Etherpad's test harness. From an etherpad checkout that has installed this plugin via `pnpm run plugins i --path ../ep_print`:
...
* Server: `eejsBlock_styles`, `eejsBlock_editbarMenuRight`
